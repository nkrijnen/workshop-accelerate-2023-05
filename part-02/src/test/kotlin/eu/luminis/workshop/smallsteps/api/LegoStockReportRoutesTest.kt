...
import eu.luminis.workshop.smallsteps.logic.domainService.helper.buildIncompleteReturn
        ...
        val stockRepository = TestLegoStockRepository(
            StockState(
                incompleteReturnHistory = listOf(
                    buildIncompleteReturn(millenniumFalcon, mapOf("3022" to 5, "20105" to 1)),
